...
<head>
  ...
  <title>{{ ucwords(strtolower($fees[0]->student_type)) }} Student Full Fees</title>
  <style>
    .page-break {
...
<body>
  <div class="container-fluid">
    <div>
      <center>
        <h3 class="main-heading">{{ ucwords(strtolower($fees[0]->student_type)) }} Student Full Fees</h3>
      </center>
    </div>
    <br>
      ...
      <table class="table table-xs table-striped">
        ...
        <tbody>
          ...
          @foreach ($fees as $row)
            ...
            <tr>
              <td>{{ $i }}</td>
              <td>{{ $row->getUniversity->name }} <br> {{ $row->getProgram->course_name }}</td>
              <td>
                {!! $otherfees->fees_description ?? 'N/A' !!}
              </td>
