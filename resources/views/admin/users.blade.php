          ...
          <div class="card-body {{ $ft=='edit'?'':'hide-this' }}" id="tblCDiv">
            <form id="{{ $ft=='add' ? 'dataForm' : 'editForm' }}" {{ $ft=='edit' ?'action='.$url:'' }} class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-12 mb-3">
                  <x-InputField type="file" label="Profile Pic" name="profile_picture" id="profile_picture" :ft="$ft" :sd="$sd"></x-InputField>
                </div>
                ...
                <div class="col-md-12 col-sm-12 mb-3">
                  <x-TextareaField label="Highlights" name="highlights" id="highlights" :ft="$ft" :sd="$sd">
                  </x-TextareaField>
                </div>
                <div class="col-md-12 col-sm-12 mb-3">
                  <x-TextareaField label="Experiance" name="experiance" id="experiance" :ft="$ft" :sd="$sd">
                  </x-TextareaField>
                </div>
                <div class="col-md-12 col-sm-12 mb-3">
                  <x-TextareaField label="Education" name="education" id="education" :ft="$ft" :sd="$sd">
                  </x-TextareaField>
                </div>
              </div>
