...
<head>
  ...
  <meta content="{{
                  config('app.name'); }}" name="description" />
        ...
        <div class="d-flex">
          ...
          <div class="navbar-brand-box">
            <a href="{{ url('admin') }}" class="logo logo-dark">
              <span class="logo-sm">
                <img src="{{ url('backend/') }}/assets/images/logo-sm.svg" alt="{{ Config('app.name') }}" height="24" />
              </span>
              <span class="logo-lg">
                <img src="{{ url('backend/') }}/assets/images/logo-sm.svg" alt="{{ Config('app.name') }}" height="24" />
        ...
        <div class="d-flex">
          ...
          <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item bg-soft-light border-start border-end"
              ...
              <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ session()->get('adminLoggedIn')['user_name']; }}</span>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="topnav-more">
                  <div class="dropdown">
                    <a class="dropdown-item dropdown-toggle arrow-none" href="{{ aurl('other-fees/') }}"
                      id="topnav-auth" role="button">
                      <span data-key="t-authentication">Other Fees</span>
                    </a>
                    <a class="dropdown-item dropdown-toggle arrow-none" href="{{ aurl('tution-fees') }}"
                      id="topnav-auth" role="button">
                      <span data-key="t-authentication">Tution Fees</span>
                    </a>
                  </div>
                </div>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle arrow-none" href="{{ aurl('export-university-programs') }}" id="topnav-dashboard"
                  role="button" title="Dashboard">
