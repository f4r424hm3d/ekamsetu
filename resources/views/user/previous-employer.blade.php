      ...
      <div class="crms-title row bg-white mb-4">
        ...
        <div class="col text-end">
          <ul class="breadcrumb bg-white float-end m-0 ps-0 pe-0">
            ...
            <li class="breadcrumb-item active">Previous Employer</li>
          </ul>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="{{ url('user/job-application/previous-employer') }}" method="post"
                  enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                    <div class="col-lg-4 col-md-4">
                      <div class="mb-3">
                        <label for="employer">Previous Employer</label>
