...
<head>
  <meta charset="utf-8" />
  <title>Admin Login | Britannica Overseas</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta content="Britannica Overseas Britannica Overseas Education" name="description" />
              ...
              <div class="d-flex flex-column h-100">
                <div class="mb-4 mb-md-5 text-center">
                  <a href="{{ url('/') }}" class="d-block auth-logo">
                    ...
                    <span class="logo-txt">Britannica Overseas</span>
                  </a>
                </div>
